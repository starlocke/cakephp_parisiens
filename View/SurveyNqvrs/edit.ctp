...
<?php echo $this->Form->create('SurveyNqvr'); ?>
	<fieldset>
		<legend><?php echo __('Edit Survey Nqvr'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SurveyNqvr.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SurveyNqvr.id'))); ?></li>
